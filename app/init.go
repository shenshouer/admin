...
func InitApp() {
	base.MONGO_DATABASE = revel.Config.StringDefault("mgo.use_database", "")
	if err := models.Startup(base.MONGO_DATABASE); err != nil {
		logger.Errorf("InitApp Startup MongoDB err[%v]", err)
	}
}
